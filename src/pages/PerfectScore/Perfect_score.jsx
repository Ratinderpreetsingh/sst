                ...
                <div className="container view_survey">
                    <div className="d-flex justify-content-between align-items-center">
                        <div className="view_survey_heading">
                            <h5><strong>Perfect Score</strong></h5>
                        </div>
                    </div>
                    <div className="row mt-3">
                        <div className="col-4">
                            <div>
                                {/* <p>Review: <span
                                        style="font-size:100%;color:#FFA534;">&starf;&starf;&starf;&starf;&starf;</span>(Perfect Score)</p> */}
                            </div>
                        </div>
                        <div className="col-4">
                            <div>
                            ...
                            <ul className="nav mb-3" id="pills-tab" role="tablist">
                                <li className="nav-item border" role="presentation">
                                    <button className="nav-link-tab active" id="pills-gravity-form-tab"
                                        ...
                                        role="tab" aria-controls="pills-gravity-form" aria-selected="true">Input
                                        Unchecked</button>
                                </li>
                                <li className="nav-item border" role="presentation">
                                    <button className="nav-link-tab" id="pills-type-embed-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-type-embed" aria-selected="false"
                                        tabindex="-1">Reviewed</button>
                                </li>
                                <li className="nav-item border" role="presentation">
                                    <button className="nav-link-tab" id="pills-type-embed-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-type-embed" type="button" role="tab"
                                        aria-controls="pills-type-embed" aria-selected="false"
                                        tabindex="-1">Ignore</button>
                                </li>
                            </ul>
                        </div>
                    </div>
